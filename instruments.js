...
const synthInstruments = {
    ...
    'Bass': {
        ...
        amplitudeEnvelope: { attack: 0.005, decay: 0.2, sustain: 0.5, release: 0.3 },
    ...
    'WobbleWobble': {
        ...
        //harmonicPitchEnvelope: { attack: 0.005, decay: 0.08, sustain: 0.0, release: 0.1, sustain: 800, release: 1.0, maxFrequency: 1200 },
    ...
    'Kick': {
        oscillators: [
            { waveform: WaveformType.SINE, detune: -4800, volume: 2 },
            { waveform: WaveformType.SINE, detune: -2400, volume: 2 },
            { waveform: WaveformType.TRIANGLE, detune: -1700, volume: 1 },
